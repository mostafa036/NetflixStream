        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RegionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RegionName = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ads = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shows = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MobileGames = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DevicesSimultaneous = table.Column<int>(type: "int", nullable: false),
                    VideoQuality = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExtraMembers = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Downloads = table.Column<int>(type: "int", nullable: false),
                    SpatialAudio = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CountryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CountryName = table.Column<string>(type: "varchar(29)", maxLength: 29, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrimary = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Languages = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSubscriptions_SubscriptionPlans_SubscriptionPlansId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfilePhotoes", x => x.PhotoId);
                    table.ForeignKey(
                        name: "FK_ProfilePhotoes_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserSubscriptionId = table.Column<int>(type: "int", nullable: false),
                    PaymentMethodid = table.Column<int>(type: "int", nullable: false),
                    UserSubscriptionsUserSubscriptionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_UserSubscriptions_UserSubscriptionsUserSubscriptionId",
                        column: x => x.UserSubscriptionsUserSubscriptionId,
                        principalTable: "UserSubscriptions",
                        principalColumn: "UserSubscriptionId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_UserSubscriptionsUserSubscriptionId",
                table: "Payments",
                column: "UserSubscriptionsUserSubscriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfilePhotoes_UserProfileId",
                table: "ProfilePhotoes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptions_SubscriptionPlansId",
