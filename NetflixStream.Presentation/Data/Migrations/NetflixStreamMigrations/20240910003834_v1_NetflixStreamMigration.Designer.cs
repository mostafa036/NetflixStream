...
namespace NetflixStream.Persistence.Data.Migrations.NetflixStreamMigrations
{
    ...
    [Migration("20240910003834_v1_NetflixStreamMigration")]
    partial class v1_NetflixStreamMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CountrySeries", b =>
                {
                    ...
                    b.ToTable("SeriesCountries", (string)null);
                });
            ...
            modelBuilder.Entity("DirectorSeries", b =>
                {
                    ...
                    b.ToTable("SeriesDirectors", (string)null);
                });
            ...
            modelBuilder.Entity("LanguageSeries", b =>
                {
                    ...
                    b.HasKey("LanguagesID", "SeriesID");

                    b.HasIndex("SeriesID");

                    b.ToTable("SeriesLanguages", (string)null);
                });
            ...
            modelBuilder.Entity("ProducerSeries", b =>
                {
                    ...
                    b.ToTable("SeriesProduceres", (string)null);
                });
